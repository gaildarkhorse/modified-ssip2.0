          ...
          <div className={classes.container}>
            <FormControl className={classes.formControl}>
              ...
              >
                ...
                <MenuItem value="Invoice">Type-1</MenuItem>
                <MenuItem value="Receipt">Type-2</MenuItem>
                <MenuItem value="Estimate">Type-3</MenuItem>
                <MenuItem value="Bill">Type-4</MenuItem>
                <MenuItem value="Quotation">Type-5</MenuItem>
              </Select>
            </FormControl>
          </div>
        </DialogContent>
